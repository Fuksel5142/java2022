...
public class C02_CollectionsDataTuru {
    /*
    Collections elmas içerisinde data türünü <>
    object seçmeniz durumunda Collection a farklı data türlerinden
    objeler koymamıza izin verir
    bu depolama açısından bize esnkelik sağlar

...
public class C09_binarySearch {
    public static void main(String[] args) {
        ...
        // Varsa index, yoksa -sira ÇOK ÖNEMLİ!!!!!!!!!!!!!

        System.out.print(Arrays.binarySearch(sayilar, 4)); // 1
        System.out.print(Arrays.binarySearch(sayilar, 15)); // 4
        System.out.print(Arrays.binarySearch(sayilar, 11)); // -5
        System.out.print(Arrays.binarySearch(sayilar, 6)); // -3
        System.out.print(Arrays.binarySearch(sayilar, -100)); // -1
    }
}
...
public class C05_hh {
    ...
    private static String sehirAl() {
        ...
        System.out.println("Lütfen şehir adınızı giriniz");
    ...
    private static String tarihAl() {
        ...
        if (yil>1900 && yil<2100) {
            ...
            System.out.println("yil için geçerli sayi yazmalısınız  (1900-2100)");
        }
        ...
        System.out.println("Lütfen gün kısmını tamsayı olarak giriniz");
        int gun=scan.nextInt();
        if (gun<=0 || gun>31){
            System.out.println("Gün gün kısmını 1-31 arasında olmalıdır");
        } else if (gun<10) {
            tarih=tarih+"0"+gun;
        }else {
            tarih=tarih+gun;

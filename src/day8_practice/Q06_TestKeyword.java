...
*/
    public static void main(String[] args) {
        ...
        testkeys(answers, keys);

    }

    private static void testkeys(char[][] answers, char[] keys) {
        for (int i = 0; i < answers.length; i++) { //her bir ogrenciye bakar , i-> ogrenci
            int sayac = 0; //her bir ogrencinin dogruy cevabini sayacagi icin, sayac buraya konur önemli
            ...
            System.out.println(i + 1 + " nolu ogrencinin dogru cevap sayisi : " + sayac);// i öğrenci için
            // sayac da j için o yüzden sayacı j deki cevap anahtarının üstüne koyduk
        }
    }
}
